...
export function groupAlerts(alerts) {
  ...
  for (const a of alerts) {
    ...
    const entry = { stat: a.stat, direction: a.direction, line: a.line, unibetLine: a.unibetLine, betclicLine: a.betclicLine, winamaxLine: a.winamaxLine, estimate: a.estimate, probability: a.probability, rawProbability: a.rawProbability ?? null, calibratedProbability: a.calibratedProbability ?? null, stakePct: a.stakePct ?? null, nearMissRecord: a.nearMissRecord ?? null, pinnacleOdds: a.pinnacleOdds, unibetOdds: a.unibetOdds, betclicOdds: a.betclicOdds, winamaxOdds: a.winamaxOdds, acceptedUnibetOdds: a.acceptedUnibetOdds ?? null, acceptedBetclicOdds: a.acceptedBetclicOdds ?? null, acceptedWinamaxOdds: a.acceptedWinamaxOdds ?? null, oddsAlert: a.oddsAlert || null, directionFlip: a.directionFlip || null, obsolete: a.obsolete || false, teammateOverlap: a.teammateOverlap || null, oppQSamePosition: a.oppQSamePosition || false, deviation: a.deviation ?? null, deviationCap: a.deviationCap ?? null, factors: a.factors ?? null, savedAt: a.savedAt || 0, stakeAmount: a.stakeAmount ?? null, stakeAmountSuggested: a.stakeAmountSuggested ?? null, floorTest: a.floorTest || false };
